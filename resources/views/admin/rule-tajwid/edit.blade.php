    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="col s10 m6 l6">
                        ...
                        <ol class="breadcrumbs mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('rule-tajwid.index') }}">Rule Tajwid</a></li>
        ...
        <div class="col s12">
            <div class="container mt-3">
                ...
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('rule-tajwid.update', $ruleTajwid->id) }}" method="post"
                                    ...
                                    <select class="select2 browser-default" name="tajwid">
                                        ...
                                        @foreach ($data as $value)
                                            <option value="{{ $value->id }}"
                                                @if ($value->id == $ruleTajwid->id_tajwid) selected @endif>{{ $value->nama_tajwid }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="input-field col m12 s12">
                                    <select class="select2 browser-default" name="synonym">
                                        ...
                                        @foreach ($dataRuleTajwid as $value)
                                            <option value="{{ $value->kode }}"
                                                @if ($value->kode == $ruleTajwid->synonym) selected @endif>{!! $value->kode .
                                                    ' - ' .
                                                    $value->keterangan .
                                                    ' (' .
                                                    html_entity_decode(json_decode('"' . $value->rule . '"'), ENT_QUOTES, 'UTF-8') .
                                                    ')' !!}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="input-field col m12 s12 mb-5">
                                    <label>
                                        <input type="checkbox" class="filled-in" name="second-rule"
                                            @if ($ruleTajwid->second_rule != null) @checked(true) @endif />
                            ...
                            <div class="row">
                                <div class="input-field col m12 s12">
                                    ...
                                    <textarea id="keterangan" name="keterangan" rows="5">{{ $ruleTajwid->keterangan }}</textarea>
                                </div>
                            </div>

                            <input type="text" id="pattern" name="rule" hidden>

                            <div class="selectHiden" hidden>
                                <select name="tandaTajwid[]" id="tanda-tajwid" multiple>
                                    @foreach ($ruleTajwid->tandaTajwid as $valueTanda)
