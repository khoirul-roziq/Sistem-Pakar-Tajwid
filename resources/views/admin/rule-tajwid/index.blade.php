                ...
                <div class="row">
                    <div class="col s10 m6 l6">
                        ...
                        <ol class="breadcrumbs mb-0">
                            ...
                            <li class="breadcrumb-item active white-text"><b>Rule Tajwid</b></li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card material-table">
                                    <div class="table-header">
                                        ...
                                        <div class="actions">
                                            ...
                                            <a href="{{ route('rule-tajwid.create') }}"
                                        ...
                                        <tbody>
                                            @foreach ($data as $value)
                                                <tr>
                                                    ...
                                                    <td><span class="font-kitab">{{ html_entity_decode(json_decode('"' . $value->rule . '"'), ENT_QUOTES, 'UTF-8')}}</span></td>
                                                    <td>
                                                        @if(!empty($value->second_rule))
                                                        <span class="font-kitab">{{ html_entity_decode(json_decode('"' . $value->second_rule . '"'), ENT_QUOTES, 'UTF-8')}}</span>
                                                        @else
                                                        -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <form action="{{ route('rule-tajwid.destroy', $value->id) }}"
                                                            ...
                                                            <ul id='aksi{{ $value->id }}' class='dropdown-content'>
                                                                <li><a href="{{ route('rule-tajwid.edit', $value->id) }}"><i
